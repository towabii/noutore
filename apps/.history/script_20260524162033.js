...
const items = [
    // --- Fun (Games) ---
    { title: "Friend Station", description: "通話機能まですべてある次世代SNS", thumbnail: "./apps/スタディーコネクト/thumbnail.png", url: "https://towabii.github.io/friend-station/", recommend: "BEST", category: "fun" },
