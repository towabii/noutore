...
const items = [
    ...
    { title: "7番出口", description: "不思議な地下通路を探索する作品。", thumbnail: "./apps/app8/thumbnail.png", url: "#", recommend: "工事中", category: "fun" },
    ...
    { title: "管理パネル", description: "開発者のみアクセス。", thumbnail: "./apps/外部URL用写真/マイウォレット.png", url: "https://towabii.github.io/kanri/", recommend: "管理者のみ", category: "other" },
];
