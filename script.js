...
const notificationData = {
    title: "【重要】ブロックトレーニングの更新について",
    text: "いつもご利用いただき、誠にありがとうございます。このたび「ブロックトレーニング」は大型アップデートを実施いたしました。#万が一、ハイスコアがリセットされていた場合は、お手数ですが 底原永和 までご連絡ください。#今後とも「ブロックトレーニング」をよろしくお願いいたします。",
    closeDelaySeconds: 3, // お知らせを閉じられるようになるまでの秒数
